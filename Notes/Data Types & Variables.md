...
Commonly used format specifiers in the below table
...
- Variable names can contain alphabets, digits & underscore(`_`).
...
[https://replit.com/@kunalshah017/Variables](https://replit.com/@kunalshah017/Variables)
